...
from diffusion_policy.common.normalize_util import (
    xarm_normalizer_from_stat,
    get_range_normalizer_from_stat,
    get_image_range_normalizer,
    get_identity_normalizer_from_stat,
    flip_action_normalizer_from_stat,
    array_to_stats
)
register_codecs()
...
class FlipDataset(BaseImageDataset):
    def __init__(self,
            shape_meta: dict,
            dataset_path: str,
            horizon=1,
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:
        ...
        coeff = MODE_QUANTILE_COEFF[self.mode][self.quantile]
        normalizer['action'] = flip_action_normalizer_from_stat(action_stat, coeff)
...
def _convert_h5_to_replay(
    ...
    with h5py.File(dataset_path) as file:
        ...
        for i in range(n_demo):
            ...
            episode_length = demo['action_rel'].shape[0]
