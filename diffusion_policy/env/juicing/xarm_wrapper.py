...
class XArmWrapper:
    def __init__(self, joints_init, ip='192.168.1.202'):
    ...
    def set_joint(self, angles, speed=32, wait=False):
        """Set joint angles. Accepts 6-DOF and pads to 7-DOF for XArm API."""
        angles_deg = np.array(angles) * 180 / np.pi  # Convert from rad to deg
